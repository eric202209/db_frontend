...
const FilterPanel = ({ onFilterChange }) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="filter-panel">
            ...
            <select name="smogRating" value={filters.smogRating} onChange={handleChange}>
                <option value="">All Smog Rating</option>
                ...
                <option value="8">8</option>
                {options.smogRating.map(smog => (
                    <option key={smog} value={smog}>{smog}</option>
                ))}
            </select>

            <select name="topEfficient" value={filters.topEfficient} onChange={handleChange}>
                <option value="">All Combined Consumption</option>
                <option value="4.4">4.4</option>
                ...
                {options.topEfficient.map(efficient => (
                    <option key={efficient} value={efficient}>{efficient}</option>
                ))}
            </select>
